...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex bg-gradient-to-tr from-[#0f172a] via-[#1e293b] to-[#020617] text-white">
      ...
      <div className="flex-1 flex flex-col justify-center px-14">
        ...
        <div className="mt-10 flex gap-6">
          ...
          <div className="backdrop-blur-md bg-white/5 p-6 rounded-2xl w-56">
            <h3 className="text-xl font-semibold text-indigo-300">🧠 Organize</h3>
            <p className="text-sm text-slate-300 mt-2">
      ...
      <div className="flex-1 flex items-center justify-center bg-white/5 backdrop-blur-xl">
        <div className="w-[420px] p-10 rounded-3xl bg-white/10 border border-white/10 shadow-xl">
          ...
          <button
            ...
            className="w-full py-4 rounded-xl bg-indigo-500 hover:bg-indigo-600 transition font-semibold text-lg"
          >
            Create Free Account
          </button>
          ...
          <button
            ...
            className="w-full py-4 rounded-xl mt-4 border border-indigo-400 text-indigo-300 hover:bg-white/10 transition font-semibold"
          >
            Sign In
          </button>
